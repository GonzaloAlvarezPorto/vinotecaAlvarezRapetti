...
export default function Home() {
  ...
  const bodegas = [
    { nombre: "Catena Zapata", imagen: "/catena.png", enlace: "https://catenazapata.com/", color: "bGc-white" },
    { nombre: "Luigi Bosca", imagen: "/luigiBosca.webp", enlace: "https://luigibosca.com/", color: "bGc-black" },
    { nombre: "Trapiche", imagen: "/trapiche.svg", enlace: "https://trapiche.com.ar/", color: "bGc-black" },
    { nombre: "Norton", imagen: "/norton.svg", enlace: "https://www.norton.com.ar/", color: "bGc-white" },
    { nombre: "Rutini", imagen: "/rutini.png", enlace: "https://rutiniwines.com/", color: "bGc-white" },
  ];
  ...
  return (
    <div className="flex-row flex-col-mQ jC-spBtw pos-rel ovF-hidden h-100 w-100">
